...
public class FragmentSettingsBindingImpl extends FragmentSettingsBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((com.ivan.androidultimateexample.ui.main.settings.SettingsViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.ivan.androidultimateexample.ui.main.settings.SettingsViewModel ViewModel) {
