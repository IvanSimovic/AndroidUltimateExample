...
public class LoginFragmentBindingImpl extends LoginFragmentBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.txtEmail, 3);
        sViewsWithIds.put(R.id.txtPassword, 4);
        sViewsWithIds.put(R.id.btnSignIn, 5);
    }
    // views
    @NonNull
    ...
    private androidx.databinding.InverseBindingListener mboundView1androidTextAttrChanged = new androidx.databinding.InverseBindingListener() {
        ...
        public void onChange() {
            ...
            // viewModel
            com.ivan.androidultimateexample.ui.main.login.LoginViewModel viewModel = mViewModel;
            // viewModel != null
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((com.ivan.androidultimateexample.ui.main.login.LoginViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.ivan.androidultimateexample.ui.main.login.LoginViewModel ViewModel) {
