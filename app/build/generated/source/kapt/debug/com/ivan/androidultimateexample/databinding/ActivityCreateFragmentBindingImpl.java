...
public class ActivityCreateFragmentBindingImpl extends ActivityCreateFragmentBinding  {
    ...
    private androidx.databinding.InverseBindingListener txtCategoryandroidTextAttrChanged = new androidx.databinding.InverseBindingListener() {
        ...
        public void onChange() {
            ...
            // viewModel
            com.ivan.androidultimateexample.ui.main.activities.ActivityCreateViewModel viewModel = mViewModel;
            // viewModel != null
    ...
    public ActivityCreateFragmentBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 8, sIncludes, sViewsWithIds));
    }
    private ActivityCreateFragmentBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((com.ivan.androidultimateexample.ui.main.activities.ActivityCreateViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.ivan.androidultimateexample.ui.main.activities.ActivityCreateViewModel ViewModel) {
