...
public final class OAuth2Authenticator_Factory implements Factory<OAuth2Authenticator> {
  ...
  public OAuth2Authenticator_Factory(Provider<OAuth2TokenStorage> oAuth2TokenStorageProvider,
  ...
  public static OAuth2Authenticator_Factory create(
      Provider<OAuth2TokenStorage> oAuth2TokenStorageProvider,
      Provider<OAuth2TokenRefresher> oAuth2TokenRefresherProvider) {
    return new OAuth2Authenticator_Factory(oAuth2TokenStorageProvider, oAuth2TokenRefresherProvider);
  }

  public static OAuth2Authenticator newInstance(OAuth2TokenStorage oAuth2TokenStorage,
      OAuth2TokenRefresher oAuth2TokenRefresher) {
    return new OAuth2Authenticator(oAuth2TokenStorage, oAuth2TokenRefresher);
  }
}
